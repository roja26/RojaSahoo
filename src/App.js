...
const Portfolio = () => {
  ...
  background: 'radial-gradient(ellipse at top, #1a1a2e 0%, #0f0f0f 50%, #000000 100%)'
      ...
      <div className="fixed inset-0 pointer-events-none z-50">
        ...
        <div className="absolute top-4 left-4 w-8 h-8 border-t-2 border-l-2 border-gray-500" />
        <div className="absolute top-4 right-4 w-8 h-8 border-t-2 border-r-2 border-gray-500" />
        <div className="absolute bottom-4 left-4 w-8 h-8 border-b-2 border-l-2 border-gray-500" />
        <div className="absolute bottom-4 right-4 w-8 h-8 border-b-2 border-r-2 border-gray-500" />
      ...
      {activeSection === 'landing' && isDragging && (
        <>
          ...
          <div 
            ...
            style={{
              background: `radial-gradient(circle 130px at ${spotlightPos.x}% ${spotlightPos.y}%, transparent 0%, transparent 30%, rgba(15,15,15,0.95) 100.5%, transparent 100%)`,
              transition: 'none'
            }}
          />
          ...
          <div 
            ...
            style={{
              clipPath: `circle(130px at ${spotlightPos.x}% ${spotlightPos.y}%)`,
              transition: 'none'
            }}
          >
            <div 
      ...
      {/* HUD Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-30 px-8 py-6">
      ...
      >
        ...
        {activeSection === 'landing' && (
          ...
          >
            <div className="text-center space-y-8 max-w-3xl">
              ...
              >
                <h1 className="text-7xl font-light tracking-tight text-white mb-4 drop-shadow-lg">
                  Roja Sahoo
                </h1>
                <div className="h-px w-32 bg-white/60 mx-auto mb-6" />
              ...
              <div 
                className="space-y-4 text-gray-200 text-sm leading-relaxed max-w-2xl mx-auto"
                style={{
        ...
        {activeSection === 'projects' && (
          <div className="min-h-screen px-12 py-32">
            <div className="max-w-5xl mx-auto">
              <div className="mb-16 space-y-2">
                <div className="flex items-center gap-3 text-gray-300 text-3xl tracking-widest font-mono mb-4">
                  <Code className="w-8 h-8" />
                  <span>PROJECT ARCHIVE</span>
                </div>
                <h2 className="text-s font-light text-gray-600 tracking-tight italic">
              ...
              <div className="space-y-6">
                {projects.map((project, idx) => (
                  <div
                    ...
                    className="group border border-gray-800 p-8 transition-all duration-500 hover:border-gray-600"
                    style={{
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="text-2xl font-light text-white group-hover:text-gray-300 transition-colors">
                        {project.title}
                      </h3>
                      {project.link && (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-gray-500 text-xs hover:text-white transition-colors duration-300 hover:border-white"
                        >
                            <Github className="w-5 h-5 group-hover:scale-110 transition-transform" />
                        </a>
                        )}
                    </div>
                    <p className="text-gray-600 text-xs tracking-wider mb-4 font-mono">
        ...
        <div className="min-h-screen px-12 py-32">
            ...
            <div 
                ...
                style={{
                filter: focusedElement && focusedElement.startsWith('interest-') 
                    ? 'blur(0px)' 
                    : 'blur(0px)',
                opacity: focusedElement && focusedElement.startsWith('interest-') 
                    ? 1 
                    : 1
                }}
            >
                ...
                <div
                    ...
                    onMouseLeave={() => setFocusedElement(null)}
                    className="group border-l-2 border-gray-800 pl-8 py-4 transition-all duration-500"
                    style={{
  ...
  <div className="relative h-80 flex items-center justify-center">
    ...
    >
      {[
        ...
        const radius = 150; // Reduced from 180
    ...
    >
      <div 
        className="w-28 h-28 rounded-full border-2 border-gray-600 bg-gray-900/80 backdrop-blur-sm flex items-center justify-center cursor-pointer transition-all duration-500"
        style={{
      ...
      >
        <span className="text-white text-sm font-light text-center leading-tight">
    ...
    {[
      ...
      return (
        ...
        >
          <div 
            className="px-3 py-1.5 rounded-full border bg-gray-900/90 backdrop-blur-sm whitespace-nowrap"
            style={{
              borderColor: '#ffffff',
              ...
              <div className="space-y-16">
                {experiences.map((exp, idx) => (
                    ...
                    <div className="flex justify-between items-start mb-8">
                        <div>
                        <h3 className="text-2xl font-light text-white mb-2 group-hover:text-gray-300 transition-colors">
                            {exp.role}
                        </h3>
                    ...
                    {/* Focus Items */}
                    <div className="space-y-6 pl-6 border-l-2 border-gray-800 group-hover:border-gray-700 transition-colors">
